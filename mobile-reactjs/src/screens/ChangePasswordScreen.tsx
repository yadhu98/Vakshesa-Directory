...
const styles = {
  ...
  input: { background: '#F5F5F5', border: '1px solid #E0E0E0', borderRadius: 8, padding: 12, fontSize: 16, color: '#000', width: '100%', marginBottom: 8, boxSizing: 'border-box' as 'border-box' },
  button: { background: '#000', color: '#fff', width: '100%', padding: 16, borderRadius: 12, textAlign: 'center' as 'center', fontWeight: 600, fontSize: 16, marginTop: 8, cursor: 'pointer', border: 'none', boxSizing: 'border-box' as 'border-box' },
